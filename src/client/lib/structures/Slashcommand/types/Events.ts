...
export interface SlashCommandRunPayload<T extends CommandInteractionOptionResolver = CommandInteractionOptionResolver>
	extends SlashCommandAcceptedPayload {
	args: T;
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface SlashCommandFinishPayload<T extends CommandInteractionOptionResolver = CommandInteractionOptionResolver>
	extends SlashCommandRunPayload<T> {}

export interface SlashCommandErrorPayload<T extends CommandInteractionOptionResolver = CommandInteractionOptionResolver>
	extends SlashCommandRunPayload<T> {
	piece: SlashCommand;
}

export interface SlashCommandSuccessPayload<T extends CommandInteractionOptionResolver = CommandInteractionOptionResolver>
	extends SlashCommandRunPayload<T> {
	result: unknown;
}
...
declare module "discord.js" {
	interface ClientEvents {
		...
		[Events.SlashCommandRun]: [interaction: CommandInteraction, command: SlashCommand, payload: SlashCommandRunPayload];
		...
		[Events.SlashCommandFinish]: [interaction: CommandInteraction, command: SlashCommand, payload: SlashCommandFinishPayload];
	}
}
