...
export type SlashCommandPreconditionEntryResolvable = SlashCommandPreconditionSingleResolvable | SlashCommandPreconditionArrayResolvable;
...
export class SlashCommandPreconditionContainerArray implements ISlashCommandPreconditionContainer {
	...
	public constructor(data: SlashCommandPreconditionArrayResolvable = [], parent: SlashCommandPreconditionContainerArray | null = null) {
		this.entries = [];
		this.runCondition =
	...
	public append<K extends SlashCommandPreconditionKeys>(entry: SlashCommandPreconditionSingleResolvableDetails<K>): this;

	public append(entry: SlashCommandPreconditionContainerArray | SlashCommandPreconditionSingleResolvable): this {
		this.entries.push(entry instanceof SlashCommandPreconditionContainerArray ? entry : new SlashCommandPreconditionContainerSingle(entry));
	...
	protected parse(entries: Iterable<SlashCommandPreconditionEntryResolvable>): this {
		for (const entry of entries)
			this.add(isSingle(entry) ? new SlashCommandPreconditionContainerSingle(entry) : new SlashCommandPreconditionContainerArray(entry, this));
	 ...
	 * ```
	 */
	public static readonly conditions = new Collection<SlashCommandPreconditionRunCondition, ISlashCommandPreconditionCondition>([
