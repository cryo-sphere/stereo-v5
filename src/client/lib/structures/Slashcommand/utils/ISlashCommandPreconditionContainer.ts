...
export type SlashCommandPreconditionContainerReturn = Awaitable<SlashCommandPreconditionContainerResult>;
...
export interface ISlashCommandPreconditionContainer {
	run(interaction: CommandInteraction, command: SlashCommand, context?: SlashCommandPreconditionContext): SlashCommandPreconditionContainerReturn;
}
